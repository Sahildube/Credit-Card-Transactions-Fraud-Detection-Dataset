...
The dataset is taken from the Kaggle Website website and it has a total of  1289169 transactions, out of which 7506 are fraudulent. Since the dataset is highly imbalanced, so it needs to be handled before model building.
...
he project pipeline can be briefly summarized in the following four steps:
